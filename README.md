...
第一步：活动期间通过我的邀请 (https://www.binance.com/zh-CN/join?ref=R1SE0A44) 链接注册币安账户（直接注册或通过不合格邀请链接注册，将不会获得奖励）,或者手动输入邀请码 R1SE0A44，推荐使用台湾ip注册, 不要使用美国,香港ip

第二步：新用户需通过币安C2C或链上转账方式入金（注意：使用币安内部转账将不满足参与资格）

第三步：交易量大于等于100美元, 充值10美元，反复刷即可，成本为0.1美元，不要使用闪兑, 不要交易稳定币)，可以按照捐赠教程 (https://github.com/kk9448/ehDonate)购买bch,反复买入卖出，即可获得空投
