...
**个人推荐**  
[币安](https://accounts.suitechsui.club/zh-CN/register?ref=R1SE0A44),世界最大的数字货币交易所(需要翻墙,推荐台湾ip，不能使用美国ip)

使用我的[邀请链接](https://accounts.suitechsui.club/zh-CN/register?ref=R1SE0A44), 或者手动填写邀请码 **R1SE0A44**，可以**免费获得5美元以及永久最高比例返现**，(推荐使用台湾ip注册, 不要使用美国,日本,或香港的ip, 币安不对这几个地方提供服务)，使用大陆身份完成验证即可, 完成验证后,请telegram **私聊 @carbon_x 领取5专属福利**[这样捐赠成本为115 RMB]

**限时免费获得E站银星活动(完成2个任务, 获得大约50美元奖励)**  

✅任务1  (新用户专享, 价值20美元)  
活动期间新注册[币安](https://accounts.suitechsui.club/zh-CN/register?ref=R1SE0A44)的用户，赠送价值20美元的代币：交易量排名前600名币安新注册用户每人可获得25枚LISTA奖励（估计价值20美元），交易量排名前600名之后的用户，将将共同瓜分15,000枚LISTA ！，无论排名如何，如果此次赠送的代币价值小于20USDT，我个人补齐到20USDT，保证至少是铜星，私聊 @carbon_x 即可

活动时间： 2024/06/03 08:00:00 - 2024/06/09 08:00:00 （北京时间）

1️⃣第一步：活动期间通过[我的邀请](https://accounts.suitechsui.club/zh-CN/register?ref=R1SE0A44) 链接注册币安账户（直接注册或通过不合格邀请链接注册，将不会获得奖励）,或者手动输入邀请码 R1SE0A44，推荐使用台湾ip注册, 不要使用美国,香港ip  
2️⃣第二步：新用户需通过币安C2C或链上转账方式入金（注意：使用币安内部转账将不满足参与资格）  
3️⃣第三步：交易量大于等于100美元, 充值10美元，反复刷即可，成本为0.1美元，不要使用闪兑, 不要交易稳定币)，教程如下
[刷100美元交易量教程](https://crypto0xpanda.notion.site/100-f10bfe98d3bf460ba98ab721418789ef?pvs=4) 

LISTA奖励将于2024年6月20日18:00（东八区时间）前直接分配到中奖用户的现货钱包

✅任务2 (新用户和老用户都可以参与, 价值大约30美元)  
完成币安Megadrop web3任务, 即可获得大约30美元空投
非常简单的任务, 新手10分钟就可以完成, 成本约为0.5美元
教程如下
[币安MegaDrop, 空投Lista教程](https://crypto0xpanda.notion.site/Megadrop-Lista-25e69dc29dbe40e3a4a89fa3c8fb0586?pvs=4) 
