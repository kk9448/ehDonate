...
免费获得金星活动, 币安新注册用户每人可获得20 AEVO (价值> 100美元), 相当于可以免费获得金星, 或者可以提现为RMB

✅活动时间：24年3月8日 08:00 至 24年3月12日 07:59（北京时间）

前1500名通过我的邀请链接 (https://www.binance.com/zh-CN/join?ref=R1SE0A44)新注册并完成一笔交易的用户（5美元任意代币即可, 不要使用闪兑, 不要交易稳定币）, 每人可获得20 AEVO（价值> 100美元）;1500名之后的用户，将共同瓜分20,000 AEVO！

注意: 前1500名估计会在3月8号下午耗尽, 请尽快完成任务, 先到先得

活动：活动期间通过我的邀请 (https://www.binance.com/zh-CN/join?ref=R1SE0A44)链接注册币安账户（推荐使用台湾ip注册, 不要使用美国,香港ip）,或者手动输入邀请码 R1SE0A44，完成一笔交易（5美元即可, 不要使用闪兑,不要交易稳定币)，可以按照捐赠教程 (https://github.com/kk9448/ehDonate)购买一笔bch, 即可获得空投, , 有问题请联系 @carbon_x, 或加入群组讨论https://t.me/carbon_research

注意：直接注册或通过不合格邀请链接注册，将不会获得奖励

空投将会在24年3月13号晚5:30左右, 分发到用户的现货账户中
